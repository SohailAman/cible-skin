...
<head>
    ...
    <title>LE SOIN RENEW-CELLULAR - Cible Skin</title>
        ...
        <main class="main">
                ...
                <div class="hero-container">
                    <div class="hero__images">
                        <div class="hero__main__image-container">
                            <img src="assets/images/common-imgs/img-skincares/h/3.jpg" alt="" class="hero__main__image"
                                id="current" />
                        </div>
                        <div class="hero__gallery-container">
                            <img src="assets/images/common-imgs/img-skincares/h/3.jpg" alt="" />
                            <img src="assets/images/common-imgs/img-skincares/h/7.jpg" alt="" />
                    ...
                    <div class="hero-content-container">
                        <div class="inner">
                            <div class="hero-content-title">
                                <h2 class="hero-title">LE SOIN RENEW-CELLULAR</h2>
                                <p class="hero-subtitle">
                                    Le soin <span>anti-âge </span>et <span>anti-rides</span> révolutionnaire

                                </p>
                            </div>
                            <div class="hero-content-tags-cellular">
                                <span class="hero-tag">
                                    <img src="assets/images/img-soincellular/img/hero/clock.svg" alt="clock image"
                                ...
                                <a href="#" class="hero-subtag">radiofrequence</a>
                                <a href="#" class="hero-subtag">bioled</a>
                                <a href="#" class="hero-subtag">jetpeel</a>
                                <a href="#" class="hero-subtag">exfoliationmecanique</a>
                                <a href="#" class="hero-subtag">drainagelymphatique</a>
            ...
            <section class="sion-main">
                <p class="hero-subtitle sion-subtitle">
                    Ce soin <span>anti-âge, anti-rides </span> haute performance est<span> spécialement</span> adapté
                    aux peaux
                    matures.Il vient<span> lifter, raffermir</span> et<span> repulper</span> la peau
                </p>
            </section>
            ...
            <section class="main__culte maison">
                <div class="maison__container">
                    <h2 class="maison__title">
                        Le Soin Renew-Cellular : le soin de nos actrices
                    </h2>
                    ...
                    <div class="swiper-wrapper splide__list soins-justify-content">
                        <div class="swiper-slide splide__slide soins-six-cards-section">
                            <img class="technique-img technique-img-1" src="assets/images/common-imgs/img-skincares/v/2.jpg"
                                alt="technique 1" />
                            <span class="technique-span">Les technique de réflexologie faciale Cible Skin </span>
                        </div>
                        <div class="swiper-slide splide__slide soins-six-cards-section">
                            <img class="technique-img" src="assets/images/common-imgs/img-skincares/v/1.jpg"
                                alt="technique 2" />
                            <span class="technique-span">L’exfoliation mécanique & le drainage lymphatique </span>
                        </div>
                        <div class="swiper-slide splide__slide soins-six-cards-section">
                            <img class="technique-img" src="assets/images/common-imgs/img-skincares/v/7.jpg"
                                alt="technique 3" />
                            <span class="technique-span">La radiofréquence</span>
                        </div>
                        <div class="swiper-slide splide__slide soins-six-cards-section">
                            <img class="technique-img" src="assets/images/common-imgs/img-skincares/v/3.jpg"
                                alt="technique 4" />
                            <span class="technique-span">Le Jet-peel</span>
                        </div>
                        <div class="swiper-slide splide__slide soins-six-cards-section">
                            <img class="technique-img" src="assets/images/common-imgs/img-skincares/v/6.jpg"
                                alt="technique 4" />
                            <span class="technique-span">La technique de la cryothérapie </span>
                        </div>
                        <div class="swiper-slide splide__slide soins-six-cards-section">
            ...
            <section class="steps-splide steps__container">
                <div class="splide__arrows">
                    <div class="step-swiper-button-prev splide__arrow splide__arrow--prev">
                        <img src="assets/images/img-soincellular/img/technique/next.svg" alt="" />
                    </div>
                    <div class="step-swiper-button-next splide__arrow splide__arrow--next">
                        <img src="assets/images/img-soincellular/img/technique/next.svg" alt="" />
                    </div>
                </div>
                <h2 class="technique-subtitle">Les 7 étapes du Soin Renew Cellular</h2>
                <!-- Swiper -->
                <div class="swiper mySwiperSteps splide__track">
                    <div class="swiper-wrapper splide__list">
                        ...
                        <div class="swiper-slide splide__slide steps-card">
                            <img class="steps-img" src="assets/images/img-soincellular/img/steps/3.jpg" alt="" />
                            <p class="steps-title">Étape 3</p>
                            <p class="steps-subtitle">L’exfoliation mécanique, le drainage lymphatique & le massage remodelant avec le Sérum Bleu</p>
                            <p class="steps-content">
                            La diffusion d’air à haute pression vient stimuler et détoxifier la peau, tout en retirant                                <span class="elipsis">...</span>
                                <span class="morePara">
                                 toutes les cellules mortes et les impuretés, préparant la peau à l’absorption des prochaines infusions d’actifs.
                                    Il s’en suit un massage modelant dynamique avec le Sérum Bleu, reconnu pour son double pouvoir hydratant et antioxydant haute performance offert par l’Extrait de Malachite et son trio d’hydratants (le Saccharide Isomerate, le Sodium Polyglutamate et l’Acide hyaluronique) tout en apportant un coup d’éclat immédiat, 
                                    renforçant la peau face aux des agressions extérieures et prévenant les signes de l’âge.
                                    <br />
                                </span>
                        ...
                        <div class="swiper-slide splide__slide steps-card">
                            <img class="steps-img" src="assets/images/common-imgs/img-skincares/h/7.jpg" alt="" />
                            <p class="steps-title">Étape 4</p>
                            <p class="steps-subtitle">
                            La radiofréquence
                            </p>
                            <p class="steps-content">
                            Cette technique vient activer la production de collagène, d’élastine et d’acide                                <span class="elipsis">...</span>
                                <span class="morePara">
                                hyaluronique pour améliorer la fermeté et l’élasticité de la peau. 
                                    <br />
                                </span>
                        ...
                        <div class="swiper-slide splide__slide steps-card">
                            <img class="steps-img" src="assets/images/common-imgs/img-skincares/h/3.jpg" alt="" />
                            <p class="steps-title">Étape 5</p>
                            <p class="steps-subtitle">
                            Diffusion du Programme Re-Cellular 12.5% par la technologie Jet-peel 
                            </p>
                            <p class="steps-content">
                            Par une infusion à haute pression permise par la technologie Jet-peel, le soin pénètre                                <span class="elipsis">...</span>
                                <span class="morePara">
                                dans toutes les couches de la peau. Il vient booster le système immunitaire et régénère la peau grâce à sa haute concentration en brevet IDANSⓇ. La Niacinamide, l’Alpha-arbutine et les Probiotiques illuminent le teint et réduisent visiblement l’apparence des taches. 
                                Les Biopeptides et l’Acide Hyaluronique offrent une action anti-âge et anti-rides instantanée.
                                    <br />
                                </span>
                ...
                <div class="signature__container">
                    ...
                    <div class="signature__cards">
                        <div class="signature__card card-item card-item_2">
                            <a href="<?= Page::SkincareSecondePeau->url() ?>">
                                <p class="card-item__title">Le Soin <br class="lg-break"> Seconde-Peau</p>
                                <p class="card-item__text" style=" margin-bottom: 12px; ">
                                Le soin <span class="span-red">ultra-hydratant</span> et
                                <span class="span-red">purifiant</span>
                            </p>
                            <img class="card-item__image" width="350" height="380"
                                src="assets/images/common-imgs/steps/3.jpg "
                                alt="a women relax on our procedures" />
                            <p class="card-item__description">
                                Ce soin <span class="span-red">anti-points noirs</span> et
                                anti-pores dilatés est parfaitement adapté aux
                                <span class="span-red">peaux grasses</span> et aux teints
                                ternes. Il
                                    <span class="span-red">hydrate, nettoie et purifie en profondeur</span>.
                            </p>
                            <a href="<?= Page::SkincareSecondePeau->url() ?>" class="card-item__btn-link">JE
                                DÉCOUVRE</a>
                            </a>
                        </div>
                        <div class="signature__card card-item card-item_2">
